...
```sh
gowheels pypi --package-name gorouter --name gorouter --repo StevenACoffman/gorouter
```
...
gowheels pypi --name gorouter --package-name gorouter --repo StevenACoffman/gorouter --upload
```
...
```sh
gowheels pypi --name gorouter --package-name gorouter --repo StevenACoffman/gorouter --version v0.5.0 --upload
```
